    ...
    <div className="w-full max-w-2xl mx-auto">
      <div
        ...
        className={`
          ...
          ${dragOver ? "border-primary bg-primary/10 scale-[1.02]" : "border-border bg-card hover:border-primary/50 hover:bg-primary/5"}
      ...
      >
        ...
        {uploading ? (
          ...
          <>
            <p className="text-foreground font-medium text-lg">Trage fișierul aici</p>
            <p className="text-muted text-sm">sau click pentru a selecta</p>
            <p className="text-muted text-xs mt-2">JPG, PNG, PDF — max 50MB</p>
          </>
        )}
      </div>
      {error && (
